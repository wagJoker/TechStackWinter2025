...
let GalleriesController = (() => {
    let _classDecorators = [(0, common_1.Controller)('galleries')];
    ...
    var GalleriesController = _classThis = class {
        constructor(galleriesService) {
            this.galleriesService = (__runInitializers(this, _instanceExtraInitializers), galleriesService);
        }
    ...
    __setFunctionName(_classThis, "GalleriesController");
    (() => {
        ...
        GalleriesController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return GalleriesController = _classThis;
})();
